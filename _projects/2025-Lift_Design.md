...
In our statics class, we were given the following problem: 
...
<img src="{{ '/assets/images/IMG_0233.jpeg' | relative_url }}" 
     alt="Lift Picture" 
     width="600" />

<img src="{{ '/assets/images/IMG_0234.jpeg' | relative_url }}" 
     alt="Lift Picture 2" 
     width="600" />